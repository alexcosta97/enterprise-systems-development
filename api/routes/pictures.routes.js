...
router.post('/', passport.authenticate('jwt', {session: false}), multer.array('picture'), pictures.createPicture);
router.put('/:id', passport.authenticate('jwt', {session: false}), multer.array('picture'), pictures.updatePicture);
